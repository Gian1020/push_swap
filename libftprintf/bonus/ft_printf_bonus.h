...
void		print_s(t_flags, char *str, int *byte);
...
void		output_hex(t_flags flag, t_print_data data, unsigned long long n, int *byte);
void		output_nbr(t_flags flag, t_print_data data, unsigned long n, int *byte);
void		putnbr_base_count(unsigned long long n, const char *base, int *byte);
...
t_flags		init_struct_flags();
t_print_data	init_struct_data();
